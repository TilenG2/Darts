...
import { getModels } from '../engine/core/SceneUtils.js';
...
export class BaseRenderer {
    ...
    // Priprava za uporabo, (prenasa resourse na graficno kartico).
    ...
    prepareImage(image) {
        if (this.glObjects.has(image)) {//Ce ta objekt ze obstaja v glObjects dictionariju ga kr vrnem ga ne rabim spet dodati.
