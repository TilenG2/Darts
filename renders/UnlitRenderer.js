...
export class UnlitRenderer extends BaseRenderer {
    ...
    constructor(gl) {
        ...
        this.programs = WebGL.buildPrograms(gl, {// Na hitro napisani vsi prenasalci podatkov na graficno
            unlit: {
    ...
    renderNode(node, mvpMatrix) {// gre po celotni hierarhiji nodov in modele zrise
        const gl = this.gl;
    ...
    renderPrimitive(primitive) {// rise objekte
        const gl = this.gl;
